...
<div class="container">
	...
	<header class="header">
	    ...
	    <div class="prf_edit_class">
	 	<form id="formCheck" method="POST" enctype="multipart/form-data" action="/UserLike/StudentEditServlet">
	 	<c:forEach var="e" items="${prfList}">
	 	<!-- 保存ボタン -->
				<div class="save-button">
					<button type="submit" name="SUBMIT" class="save" title="編集内容を保存する" value="保存">保存</button>
				</div>
			...
			<table class="edit_table">
				...
				<tr>
					...
					<c:if test="${e.gender == 'M'}">
						<td><input type="radio" id="man" name="GENDER" checked="checked" value="M" class="s-form-text" /><label class="radio02" for="man">男</label>
						<input type="radio" name="GENDER" id="woman" value="F" class="s-form-text" /><label class="radio02" for="woman">女</label></td>
					</c:if>
					<c:if test="${e.gender != 'M'}">
						<td><input type="radio" id="man" name="GENDER" checked="checked" value="M" class="s-form-text" /><label class="radio02" for="man">男</label>
						<input type="radio" name="GENDER" id="woman" checked="checked" value="F" class="s-form-text" /><label class="radio02" for="woman">女</label></td>
					</c:if>
				</tr>
				...
				<tr>
						...
						<td><p><input type="text" name="S_MAIL" value="${e.s_mail}" class="s-form-texte validate[maxSize[30]]" /></p></td>
				</tr>
				...
				<tr>
						...
						<td><p><input type="text" name="COLLEGE" value="${e.college}" class="s-form-texte validate[maxSize[10]]" /></p></td>
				</tr>

				<tr>
						<th><label class="prf_edit_title">出身地</label></th>
						<td><p><input type="text" name="B_PLACE" value="${e.b_place}" class="s-form-texte validate[maxSize[10]]" /></p></td>
				</tr>
			...
			<div id="HOBBY">
				...
				<p><input type="text" name="HOBBY" value="${e.hobby}" class="s-form-text validate[maxSize[100]]" /></p>
			</div>
			<br>

			<div id="SKILL">
				<label class="prf_edit_titles">特技</label>
				<p><input type="text" name="SKILL" value="${e.skill}" class="s-form-text validate[maxSize[100]]" /></p>
			</div>
			<br>

			<div id="MUSIC">
				<label class="prf_edit_titles">好きな音楽</label>
				<p><input type="text" name="MUSIC" value="${e.music}" class="s-form-text validate[maxSize[100]]" /></p>
			</div>
			<br>

			<div id="JOB">
				<label class="prf_edit_titles">バイト経験</label>
				<p><input type="text" name="JOB" value="${e.job}" class="s-form-text validate[maxSize[100]]" /></p>
			</div>
			<br>

			<div id="ACTIVITY">
				<label class="prf_edit_titles">課外活動経験</label>
				<p><input type="text" name="ACTIVITY" value="${e.activity}" class="s-form-text validate[maxSize[100]]" /></p>
			</div>
            <br>
			<div id="PR">
				<label class="prf_edit_titles">自己PR</label>
				<p><input type="text" name="PR" value="${e.pr}" class="s-form-text validate[maxSize[100]]" /></p>
			</div>
            <br>

...
<div class="container">
	...
	<main class="main" id="tmin">
       ...
       <div class="main-ys">
		...
		<!--コンテンツ01-->
		<div class="mainarea" id="abtyzw">
		<p class="abt-yzw mainlink">ABOUT</p>
		...
		<!--コンテンツ02-->
		<div class="mainarea" id="conceptyzw">
        <p class="cct-yzw mainlink">CONCEPT</p>
		...
		<!--コンテンツ03-->
		<div class="mainarea" id="contactyzw">
		<p class="cct-yzw mainlink">CONTACT</p>
